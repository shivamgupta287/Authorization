...
const examples = [
  { href: "/examples/cards", label: "Examples" },
  ...
  { href: "/examples/forms", label: "Forms" },
  { href: "/examples/music", label: "Music" },
  { href: "/examples/authentication", label: "Authentication", active: true },
]
          ...
          <div className="mb-4 flex items-center overflow-x-auto">
            {examples.map((example) => (
              <a
                key={example.href}
                href={example.href}
                className={`flex h-7 items-center justify-center rounded-full px-4 text-center text-sm transition-colors hover:text-primary whitespace-nowrap ${
                  example.active
        ...
        <div className="overflow-hidden rounded-[0.5rem] border bg-background shadow">
          <div className="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
            <Button
              ...
              asChild
            >
              <a href="/examples/authentication">Login</a>
            </Button>
